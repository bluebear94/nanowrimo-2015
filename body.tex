...
\q{
	...
	After constructing the card, it must be tested. This is as simple as casting the card and inspecting the results, often multiple times in order to account for any variability.
